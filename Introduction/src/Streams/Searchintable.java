...
public class Searchintable {
	...
	public static void main(String[] args) {
		...
		List<WebElement> veggie = elementlist1.stream().filter(s->s.getText().contains("Rice")).collect(Collectors.toList());
		Assert.assertEquals(veggie.size(), elementlist1.size());
